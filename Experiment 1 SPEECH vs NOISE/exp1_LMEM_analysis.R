...
full_data <- read.csv(file=sprintf(paste(dirname(rstudioapi::getSourceEditorContext()$path), '/LMEM R data exp1/R_data_speech_noise_HbO_HbR.csv', sep = ""), header=FALSE, sep=","))
...
#########################################################################################
## calculate the percetage of reference channel attributed to 
...
# right STG
peak_R_STG_noise_HbO <- vector()
d_prime_noise_HbO <- vector()
R_STG_noise_HbO <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbO <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 1 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
  ...
  peak_R_STG_noise_HbO <- c(peak_R_STG_noise_HbO, abs(max(d_prime_vs_HbO_peak_HbO$predicted)))
  d_prime_noise_HbO <- c(d_prime_noise_HbO , d_prime_vs_HbO_peak_HbO$d_prime[1])
  R_STG_noise_HbO <- rbind(R_STG_noise_HbO, d_prime_vs_HbO_peak_HbO$predicted)
}
# left STG
peak_L_STG_noise_HbO <- vector()
d_prime_noise_HbO <- vector()
L_STG_noise_HbO <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbO <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 1 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_L_STG_noise_HbO <- c(peak_L_STG_noise_HbO, abs(max(d_prime_vs_HbO_peak_HbO$predicted)))
  d_prime_noise_HbO <- c(d_prime_noise_HbO , d_prime_vs_HbO_peak_HbO$d_prime[1])
  L_STG_noise_HbO <- rbind(L_STG_noise_HbO, d_prime_vs_HbO_peak_HbO$predicted)
}
# right cIFS
peak_R_cIFS_noise_HbO <- vector()
d_prime_noise_HbO <- vector()
R_cIFS_noise_HbO <-vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbO <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 1 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_R_cIFS_noise_HbO <- c(peak_R_cIFS_noise_HbO, abs(max(d_prime_vs_HbO_peak_HbO$predicted)))
  d_prime_noise_HbO <- c(d_prime_noise_HbO , d_prime_vs_HbO_peak_HbO$d_prime[1])
  R_cIFS_noise_HbO <- rbind(R_cIFS_noise_HbO, d_prime_vs_HbO_peak_HbO$predicted)
}
# left cIFS
peak_L_cIFS_noise_HbO <- vector()
d_prime_noise_HbO <- vector()
L_cIFS_noise_HbO <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbO <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 1 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_L_cIFS_noise_HbO <- c(peak_L_cIFS_noise_HbO, abs(max(d_prime_vs_HbO_peak_HbO$predicted)))
  d_prime_noise_HbO <- c(d_prime_noise_HbO , d_prime_vs_HbO_peak_HbO$d_prime[1])
  L_cIFS_noise_HbO <- rbind(L_cIFS_noise_HbO, d_prime_vs_HbO_peak_HbO$predicted)
}
...
# masker_configuration 2 noise, HbO, 4 region
# right STG
peak_R_STG_noise_HbR <- vector()
d_prime_noise_HbR <- vector()
R_STG_noise_HbR <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbR <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 2 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_R_STG_noise_HbR <- c(peak_R_STG_noise_HbR, abs(max(d_prime_vs_HbO_peak_HbR$predicted)))
  d_prime_noise_HbR <- c(d_prime_noise_HbR, d_prime_vs_HbO_peak_HbR$d_prime[1])
  R_STG_noise_HbR <- rbind(R_STG_noise_HbR, d_prime_vs_HbO_peak_HbR$predicted)
}

# left STG
peak_L_STG_noise_HbR <- vector()
d_prime_noise_HbR <- vector()
L_STG_noise_HbR <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbR <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 2 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_L_STG_noise_HbR <- c(peak_L_STG_noise_HbR, abs(max(d_prime_vs_HbO_peak_HbR$predicted)))
  d_prime_noise_HbR <- c(d_prime_noise_HbR , d_prime_vs_HbO_peak_HbR$d_prime[1])
  L_STG_noise_HbR <- rbind(L_STG_noise_HbR, d_prime_vs_HbO_peak_HbR$predicted)
}
# right cIFS
peak_R_cIFS_noise_HbR <- vector()
d_prime_noise_HbR <- vector()
R_cIFS_noise_HbR <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbR <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 2 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_R_cIFS_noise_HbR <- c(peak_R_cIFS_noise_HbR, abs(max(d_prime_vs_HbO_peak_HbR$predicted)))
  d_prime_noise_HbR <- c(d_prime_noise_HbR , d_prime_vs_HbO_peak_HbR$d_prime[1])
  R_cIFS_noise_HbR <- rbind(R_cIFS_noise_HbR, d_prime_vs_HbO_peak_HbR$predicted)
}
# left cIFS
peak_L_cIFS_noise_HbR <- vector()
d_prime_noise_HbR <- vector()
L_cIFS_noise_HbR <- vector()
for (subject_ID in c(1:14)){
  d_prime_vs_HbO_peak_HbR <- d_prime_vs_HbO_peak[d_prime_vs_HbO_peak$HbO_HbR == 2 &
                                                 d_prime_vs_HbO_peak$SID == subject_ID &
                                                 d_prime_vs_HbO_peak$masker_configuration == 2 &
  ...
  peak_L_cIFS_noise_HbR <- c(peak_L_cIFS_noise_HbR, abs(max(d_prime_vs_HbO_peak_HbR$predicted)))
  d_prime_noise_HbR <- c(d_prime_noise_HbR , d_prime_vs_HbO_peak_HbR$d_prime[1])
  L_cIFS_noise_HbR <- rbind(L_cIFS_noise_HbR, d_prime_vs_HbO_peak_HbR$predicted)
}

## save data for analysis
#trace data
setwd(paste(dirname(rstudioapi::getSourceEditorContext()$path), '/model only trace exp1', sep = ""))
...
write.csv(L_cIFS_noise_HbO, file = "L_cIFS_noise_HbO.csv")
write.csv(L_cIFS_noise_HbR, file = "L_cIFS_noise_HbR.csv")
write.csv(L_STG_noise_HbO, file = "L_STG_noise_HbO.csv")
write.csv(L_STG_noise_HbR, file = "L_STG_noise_HbR.csv")
write.csv(R_cIFS_noise_HbO, file = "R_cIFS_noise_HbO.csv")
write.csv(R_cIFS_noise_HbR, file = "R_cIFS_noise_HbR.csv")
write.csv(R_STG_noise_HbO, file = "R_STG_noise_HbO.csv")
write.csv(R_STG_noise_HbR, file = "R_STG_noise_HbR.csv")
# correlation data
setwd(paste(dirname(rstudioapi::getSourceEditorContext()$path), '/behavioral and hemodynamic responses data exp1', sep = ""))
...
write.csv(rbind(peak_R_STG_noise_HbO, d_prime_noise_HbO), file = "R_STG_noise_HbO_peak_d.csv")
write.csv(rbind(peak_L_STG_noise_HbO, d_prime_noise_HbO), file = "L_STG_noise_HbO_peak_d.csv")
write.csv(rbind(peak_R_cIFS_noise_HbO, d_prime_noise_HbO), file = "R_cIFS_noise_HbO_peak_d.csv")
write.csv(rbind(peak_L_cIFS_noise_HbO, d_prime_noise_HbO), file = "L_cIFS_noise_HbO_peak_d.csv")
...
write.csv(rbind(peak_R_STG_noise_HbR, d_prime_noise_HbR), file = "R_STG_noise_HbR_peak_d.csv")
write.csv(rbind(peak_L_STG_noise_HbR, d_prime_noise_HbR), file = "L_STG_noise_HbR_peak_d.csv")
write.csv(rbind(peak_R_cIFS_noise_HbR, d_prime_noise_HbR), file = "R_cIFS_noise_HbR_peak_d.csv")
write.csv(rbind(peak_L_cIFS_noise_HbR, d_prime_noise_HbR), file = "L_cIFS_noise_HbR_peak_d.csv")
