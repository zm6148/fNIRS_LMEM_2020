...
% load csv as table
% HbO 1; HbR 2
HbO_M = csvread('\LMEM R data exp2\R_data_speech_speechoppo_HbO.csv');
HbR_M = csvread('\LMEM R data exp2\R_data_speech_speechoppo_HbR.csv');
...
% save as cvs
% go up one directory
csvwrite([pwd, '\LMEM R data exp2\R_data_speech_speechoppo_HbO_HbR.csv'], data_for_R);